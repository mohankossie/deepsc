...
#     # args.vocab_file = '/Users/mohankossie/Development/projects/deep_learning/DeepSC-master/data/' + args.vocab_file
...
if __name__ == '__main__':
    ...
    # Fix vocab file path if needed
    args.vocab_file = os.path.join('data', args.vocab_file)  # or use full path
    vocab = json.load(open(args.vocab_file, 'rb'))
    token_to_idx = vocab['token_to_idx']
    num_vocab = len(token_to_idx)
    pad_idx = token_to_idx["<PAD>"]
